...
const services = [
  ...
  { id: 3, title: "Backend Development", description: "Developing robust server-side logic and database." },
  ...
  {id:6,title:"Digital Marketing",description:"Promote your business with dgital marketing team"}
];
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {services.map((service) => (
            <div key={service.id} className='bg-gray-800 px-6 pb-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105'>
              ...
              <a href="#" className='mt-4 inline-block text-gray-400 hover:text-blue-500'>Read More</a>
            </div>
          ))}
        </div>
      </div>
